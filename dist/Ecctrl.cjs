...
const applyGForce = (gForceDirection, bodyPosition, bodyForce, bodyMass) => {
...
const Ecctrl = react.forwardRef(({
  ...
  react.useMemo(() => new THREE__namespace.Vector3(1, 0, 0), []);
  ...
  react.useMemo(() => new THREE__namespace.Quaternion(), []);
  ...
  const rayCast2 = new rapier$1.Ray(rayOrigin, rayDir2);
  let rayHit = null;
  let slopeAngle = null;
  ...
  fiber.useFrame((state, delta) => {
    ...
    if (rayHit && canJump) {
      if (rayHit.collider.parent()) {
        ...
        const gravityDirection = rayHit.collider.parent().translation();
        new THREE__namespace.Vector3();
        new THREE__namespace.Vector3();
        new THREE__namespace.Quaternion();
        new THREE__namespace.Quaternion();
        distanceFromCharacterToObject.copy(currentPos).sub(gravityDirection);
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: /* @__PURE__ */ jsxRuntime.jsxs(
    rapier.RigidBody,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(rapier.CapsuleCollider, { args: [capsuleHalfHeight, capsuleRadius] }),
...
exports.applyGForce = applyGForce;
